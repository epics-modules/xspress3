...
int     xsp3_playback_load_x3(int path, int card, char *filename, int src[8],  int file_streams, int str0dig, int smooth_join, int enb16chan); 
...
/* Start or XSPESS3 in Virtex 7 and XSPRESS4 code
 *
 *
 */
